    ...
    class Program
    {
        static void Main(string[] args)
        {
            using (var connection = new Connection())
            {
                ...
                Console.WriteLine("До сборки мусора (ссылка есть) поколение - " + System.GC.GetGeneration(obj)); 
                System.GC.Collect();
                Console.WriteLine("После сборки мусора (ссылка есть) поколение - " + System.GC.GetGeneration(obj));
                obj = null;
